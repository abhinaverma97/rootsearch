                    ...
                    <div className="bg-[#0A0A0B] border border-white/5 rounded-2xl p-8 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                {isPro && (
                                    <div className="flex gap-3">
                                        <button onClick={() => alert('Manage subscription coming soon')} className="px-4 py-2 bg-white/5 hover:bg-white/10 text-white text-sm font-semibold rounded-lg border border-white/10 transition-colors">
                                            Manage
                                        </button>
                                        <button onClick={() => alert('Cancel flow not implemented yet')} className="px-4 py-2 text-zinc-500 hover:text-red-400 text-sm transition-colors">
                                            Cancel
                                        </button>
                                    </div>
                                )}
                            ...
                            <div className="space-y-4">
                                <h3 className="text-sm font-semibold text-zinc-400 uppercase tracking-wider">Included in your plan</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {currentPlan?.features.map((feature, i) => (
                                        <div key={i} className="flex items-center gap-3 p-3 rounded-lg border bg-white/5 border-white/5">
